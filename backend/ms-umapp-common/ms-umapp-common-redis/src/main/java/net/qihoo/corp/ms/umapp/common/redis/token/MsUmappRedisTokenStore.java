package net.qihoo.corp.ms.umapp.common.redis.token;
 ...
 * @author wangchuanhai
 * @version 1.0.0
 * @PackageName: net.qihoo.corp.ms.umapp.common.redis.token
 * @ClassName: MsUmappRedisTokenStore
 * @Description:
 * @date 2022-10-11 18:09:49
 */
@Component
@SuppressWarnings("all")
public class MsUmappRedisTokenStore implements TokenStore {
    ...
    public MsUmappRedisTokenStore(RedisConnectionFactory connectionFactory) {
