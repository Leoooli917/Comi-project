 ...
 * @ClassName: MsUmappRemoteClientUtil
 * @Description:
 * @date 2022-10-11 17:23:09
 */
public class MsUmappRemoteClientUtil {

    public static String callRemotePostInterface(JSONObject jsonParam, String gatewayUrl, String postUrl) {
    ...
    public static String callRemoteInterface(String gatewayUrl, String getUrl) {
        HttpClient client = HttpClients.createDefault();
        // 要调用的接口方法
    ...
    public static String callRemoteGetInterface(String gatewayUrl, String getUrl) {
        HttpClient client = HttpClients.createDefault();
        // 要调用的接口方法
        String url = gatewayUrl + getUrl;
